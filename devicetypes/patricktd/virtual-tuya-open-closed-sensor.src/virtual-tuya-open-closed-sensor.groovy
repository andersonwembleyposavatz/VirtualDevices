...
metadata {
	definition(name: "VIRTUAL Tuya Open/Closed Sensor", namespace: "patricktd", author: "Patrick Teixeira (Patte Tech)", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, genericHandler: "Zigbee", ocfDeviceType: "x.com.st.d.sensor.contact") {
		capability "Battery"
