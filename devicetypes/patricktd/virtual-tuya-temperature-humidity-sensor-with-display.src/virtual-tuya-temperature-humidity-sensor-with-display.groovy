/**
 *  Tuya Temperature Humidity SensorWith Display
 *  Version 0.1
 *
 *
 ...
 *
 *  Original device handler code by a4refillpad and bspranger, adapted for use with BlitzWolf Modelo by Patrick Teixeira (Patte Tech)
 * 
 *  Known issues:
 *  Battery not show
 */
...
metadata {
	definition (name: "VIRTUAL Tuya Temperature Humidity Sensor with Display", namespace: "patricktd", author: "Patrick Teixeira (Patte Tech)") {
    ...
    fingerprint profileId: "0104", deviceId: "0302", inClusters: "0000, 0001, 0402, 0405", outClusters: "0019", manufacturer: "_TYZB01_hjsgdkfl", model: "TS0201"
